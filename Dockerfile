...
ARG VITE_API_BASE_URL=https://v25platformtrainingbackend-production.up.railway.app

# Set environment variable for API URL (default for standalone deployment)
ENV VITE_API_BASE_URL=${VITE_API_BASE_URL}
ENV VITE_REGISTRATION_API_URL=https://v25registrationbackend-production.up.railway.app/api
